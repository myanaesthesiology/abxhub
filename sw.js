...
const CACHE = 'abxhub-v0.20.0-r19';
const APP_SHELL = [
  './',
  './index.html',
  './styles.css?v=0.20.0-r19',
  './app.js?v=0.20.0-r19',
  './manifest.webmanifest?v=0.20.0-r19',
  './data/clinical-data.json',
  './data/nag-topics.json',
  './data/source-parity.json',
  './assets/source-images/msidc-p55-figure.webp',
  './assets/source-images/msidc-p57-figure.webp',
  './assets/source-images/msidc-p58-figure.webp',
  './assets/source-images/msidc-p82-figure.webp',
  './assets/source-images/msidc-p84-figure.webp',
  './assets/source-images/preg-p1-source.webp',
  './assets/source-images/preg-p2-source.webp',
  './assets/source-images/preg-p3-source.webp',
  './icons/icon-192.png',
  './icons/icon-512.png',
