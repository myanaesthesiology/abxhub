...
for token in ['./styles.css?v=0.20.0-r3','./app.js?v=0.20.0-r3','./manifest.webmanifest?v=0.20.0-r3']:
    check(token in index,f'index versioned asset missing: {token}')
check("const CACHE = 'abxhub-v0.20.0-r3'" in sw,'service worker cache name mismatch')
