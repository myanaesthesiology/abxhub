...
check("const CACHE = 'abxhub-v0.20.0-r3'" in sw,'service-worker cache not v0.20.0')
check('sw.js?v=0.20.0-r3' in app and 'app.js?v=0.20.0-r3' in index,'versioned v0.20 assets not wired')
# Data gates
