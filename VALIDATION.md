...
- all 26 organism syndrome/resistance-linked antimicrobial guides and curated drug links;
- all 63 disease practical pathways;
- all 12 resistance practical-management guides;
- CRAB detailed source cards and sulbactam renal/preparation table;
- AmpC, ESBL, CRE/CPE/NDM/KPC/OXA-48-like, MDR/DTR Pseudomonas, Stenotrophomonas and MRSA/MSSA management-layer completeness;
...
Manual source spot-checking is recorded in `HIGH_RISK_SOURCE_SPOTCHECK_v0.20.0.md`. The review now also covers AmpC, ESBL, CRE/CP-CRE/NDM, MDR/DTR Pseudomonas, Stenotrophomonas, PJI and the MSIC voriconazole renal/formulation row. `EXPANDED_CONTENT_AUDIT_v0.20.0.md` lists coverage across all 63 conditions, 26 organisms and 12 resistance pathways.

## Browser/PWA limitation

A real Chromium test against the local build could not be completed reliably. Loopback/container navigation was blocked by the environment, and a later file-origin headless attempt hung before DOM capture. This is not counted as a passed browser test.
