...
This build includes a `references/` folder containing the supplied source PDFs. GitHub Pages will serve them as static files. Before using a public repository, verify redistribution permission for each PDF; otherwise use a private repository or remove the PDF files from the public build.
