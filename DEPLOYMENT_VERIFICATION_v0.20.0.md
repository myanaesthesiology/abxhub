...
The release environment attempted Chromium navigation to both `127.0.0.1` and the container network address. Chromium returned `ERR_BLOCKED_BY_ADMINISTRATOR` before page load. The package itself does not contain a deployed GitHub Pages URL, and no public AbxHub deployment was discoverable during the build.
...
- [ ] Organism antimicrobial quick/pathway links work.
...
- [ ] Clinical DB is the v0.20 dataset (1,721 source-reference objects in the packaged build).
